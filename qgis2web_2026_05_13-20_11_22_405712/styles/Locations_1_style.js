var size = 0;
var placement = 'point';
function categories_Locations_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Food & Cofee':
...
var style_Locations_1 = function(feature, resolution){
    ...
    var labelText = ""; 
    var labelFont = "9.1px \'Britannic Bold\', sans-serif";
    ...
    if (size == 1) { // If cluster has one feature
        ...
        value = clusteredFeatures[0].get("categ");
    ...
    var style = categories_Locations_1(feature, value, size, resolution, labelText,
